...
semilogy(rho,arr_evo_ne[2][-ptgyro-1:],'-or',linewidth=2)
legend(loc='lower right',fontsize=fs1).draggable(True)
xticks(fontsize=fs1,family='serif')
yticks(fontsize=fs1,family='serif')
ylabel('GyroBohm',fontsize=fs2,family='serif')
...
subplot(2,2,4)
semilogy(rho,abs(arr_evo_Er[1][-ptgyro-1:]),'-*k',linewidth=2)
semilogy(rho,abs(arr_evo_Er[2][-ptgyro-1:]),'-or',linewidth=2)
legend(loc='lower right',fontsize=fs1).draggable(True)
xticks(fontsize=fs1,family='serif')
yticks(fontsize=fs1,family='serif')
ylim([1.e-3,1.e2])
